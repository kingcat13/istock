...
public class KafkaSender {
	...
	public void sendStockDataDay(StockDataDay stockDayData){

		try {
			createProducer().send(new KeyedMessage<Integer, String>(topic, mapper.writeValueAsString(stockDayData)));
